...
<body>
    ...
    <section>
        <div class="titulo">
            ...
            <div class="cuerpo">
                <span>Compras</span> <i class="ti-angle-right"></i> <span>Compras</span>
            </div>
        </div>
                        ...
                        <div class="card-body">
                            ...
                            <div class="table-responsive">
                                <table id="tabla-reporte" class="table table-hover table-striped table-bordered">
                                    ...
                                    <tbody>
                                        <?php
                                        require('config/funciones-compras.php');
